...
| B-134 | 未着手 | サンプル修正記録の削除（物理削除。SampleRevision は deletedAt を持たず SOFT_DELETE_MODELS 対象外＝構造上許可・revisionOrder は詰め直さない・確認ダイアログ必須）。実装ブリーフは 2026-08-11 チャットに全文あり・未実行 | — |
