...
/**
 * B-093 PR-1（D-4）: shadcn の sheet を、既存 dialog.tsx と同じ `radix-ui` の Dialog で手書き追加。
 * 新しい npm パッケージは増やさない。スマートフォン幅のメニュー（左からのパネル）に使う。
 */
  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        data-side={side}
        className={cn(
          "fixed z-50 flex flex-col gap-4 bg-background shadow-lg outline-none transition ease-in-out duration-300 data-open:animate-in data-closed:animate-out",
          side === "right" &&
